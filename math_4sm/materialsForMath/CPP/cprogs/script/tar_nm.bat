@echo off
rem tar_nm.bat : package the NM_LIB source files and documents...
rem set up for GNU tar and gzip on a Win32 system

rem It is assumed that we are starting in the nm_lin/script directory
