...
int alloc_bezier_3_poly (bp, n)
struct bezier_3_poly_data *bp;
int n;
...
int init_bezier_3 (b3, loc0, loc1, loc2, loc3)
...
int init_bezier_n (n, bn, locarray)
int    n;
struct bezier_n_data *bn;
struct point_3D locarray[];
...
int deriv_bezier_3 (b3, t, dxyzdt)
struct bezier_3_data *b3;
double t;
struct point_3D *dxyzdt;
...
int segment_bezier_3_poly (bp, loc0, loc1, loc2, loc3, i)
struct bezier_3_poly_data *bp;
struct point_3D *loc0, *loc1, *loc2, *loc3;
int    i;
...
int normalize_bezier_3_poly (bp)
struct bezier_3_poly_data *bp;
...
int eval_bezier_3_poly (bp, t_star, loc)
struct bezier_3_poly_data *bp;
double t_star;
struct point_3D *loc;
...
int coons_bezier_3 (c1, c2, c3, c4, r, s, d)
struct bezier_3_poly_data *c1, *c2, *c3, *c4;
double r, s;
struct point_3D *d;
